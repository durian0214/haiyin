 ...
 * 2019/1/18.
 */
public class EnterpriseAdapter extends BaseQuickAdapter<EnterpriseEntity.DataBean, BaseViewHolder> {
    public EnterpriseAdapter(int layoutResId) {
        super(layoutResId);
    }

    @Override
    protected void convert(BaseViewHolder helper, EnterpriseEntity.DataBean item) {
