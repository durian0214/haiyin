...
/**
 * Created by durian on 2017/11/6.
 * sharedPreferences 本地存储工具类
 */

public  class SharedPreferencesUtils {
    /** 文件名 **/
    public static final String fileName = SharedPreferencesVar.FILE_NAME;
    ...
    public static final String FILE_PATH = BaseApplication.getAppContext().getExternalFilesDir(null).getAbsolutePath();
