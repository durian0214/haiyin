...
public class ImageUtil {
    ...
    public static Uri saveImage(Context context, String url, Bitmap bitmap,String imgName) {
        //保存路径
        String imgDir = Environment.getExternalStorageDirectory().getPath() + "/haiyin/" + path;
        //图片名称处理
        ...
        try {
            ...
            if (compress) {
                Toast.makeText(context, "保存成功，路径/sd卡/" + path + "文件夹中" , Toast.LENGTH_LONG).show();
            } else {
