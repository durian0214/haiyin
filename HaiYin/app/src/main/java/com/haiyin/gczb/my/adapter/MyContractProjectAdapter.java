 ...
 * 2019/1/3.
 */
public class MyContractProjectAdapter extends BaseQuickAdapter<GetMyContractProjectsEntity.DataBean, BaseViewHolder> {
    public MyContractProjectAdapter(int layoutResId) {
        super(layoutResId);
    }

    @Override
    protected void convert(BaseViewHolder helper, GetMyContractProjectsEntity.DataBean item) {
